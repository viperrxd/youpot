...
// Timeout wrapper to prevent the server from hanging indefinitely if blocked
...
app.get('/', async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, error: "Failed to generate tokens", details: error.message });
    }
});
